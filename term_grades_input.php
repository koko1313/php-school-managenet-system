<?php 
	...
	if ( !($_SESSION["role"] === "teacher" || $_SESSION["role"] === "class teacher") ) header("location: term_grades.php");
	include("term_grades_io.php");
	$page_now="term_grades";
?>
...
<div class="row">
	<div class="col-md-6 col-md-offset-3">
		<form method="post" name="form" action="term_grades_input.php">
			...
			<?php if(isset($_GET["edit"])){ ?>
				<button type="submit" name="edit_term_grade" class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Редактирай</button>
				<a href="term_grades.php" class="btn btn-default">Отказ</a>
			<?php } else if(isset($_GET["delete"])){ ?>
				<button type="submit" name="delete_term_grade" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Изтрий</button>
				<a href="term_grades.php" class="btn btn-default">Отказ</a>
			<?php } else { ?>
				<button type="submit" name="submit_term_grade" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-open"></span> Въведи</button>
				<a href="term_grades.php" class="btn btn-default"><span class="glyphicon glyphicon-search"></span> Виж всички</a>
			<?php } ?>
		</form>
	</div>
</div>
