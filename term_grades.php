...
<div class="row">	
	<div class="col-md-2">
		...
		<?php if ($_SESSION["role"] === "teacher" || $_SESSION["role"] === "class teacher") { ?>
			<a href="term_grades_input.php" class="btn btn-link">Въвеждане на нова оценка</a>
		<?php } ?>
	...
	<div class="col-md-10">
		...
		<table id="filteredTable" class="table-mobile table table-striped table-hover">
			<thead>
			<tr>
