<?php 
	...
	if ( !($_SESSION["role"] === "teacher" || $_SESSION["role"] === "class teacher") ) header("location: session_grades.php");
...
<div class="row">
	<div class="col-md-6 col-md-offset-3">
		<form method="post" name="form" action="session_grades_input.php">
			...
			<div class="form-group">
				<select id="session_grades_input_student" name="student_egn" class="form-control">
			...
			<?php if(isset($_GET["edit"])){ ?>
				<button type="submit" name="edit_session_grade" class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Редактирай</button>
				<a href="session_grades.php" class="btn btn-default">Отказ</a>
			<?php } else if(isset($_GET["delete"])){ ?>
				<button type="submit" name="delete_session_grade" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Изтрий</button>
				<a href="session_grades.php" class="btn btn-default">Отказ</a>
			<?php } else { ?>
				<button type="submit" name="submit_session_grade" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-open"></span> Въведи</button>
				<a href="session_grades.php" class="btn btn-default"><span class="glyphicon glyphicon-search"></span> Виж всички</a>
			<?php } ?>
		</form>
	</div>
</div>
